...
@safe_handler(
    "Постинг: получение имени кнопки"
)  # Безопасная обёртка: логирование + перехват ошибок без падения бота
...
@safe_handler(
    "Постинг: текст для не-подписчика"
)  # Безопасная обёртка: логирование + перехват ошибок без падения бота
