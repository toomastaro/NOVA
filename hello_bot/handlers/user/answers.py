...
from hello_bot.utils.schemas import Answer as AnswerObj
from hello_bot.utils.schemas import Media, MessageOptions
...
async def manage_answer(
    ...
    message_text = text(f"answer:change:{temp[1]}")
    if temp[1] == "keyword":
